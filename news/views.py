...
def show(request, category=None):
    ...
    return render(request, 'news.html', {'list_news': news_on_page, 'news_title': news_title[category]})
...
def rates(request):
	...
	return render(request, 'rates.html', context={'list_rates': current_date, 'list_exchange': list_exchange})
